	...
	return (
		<div className="form">
			<S.FormWrapper onSubmit={handleSubmit(onSubmit)}>
				<TextField
					placeholder={'Dê um nome à sua marca'}
					label="Nome"
					name="name"
					required
					onInvalid={(e) => {
				...
				/>
				<C.BrandText>
					Todos os membros da sua equipe verão este nome e poderão utilizar esta
					marca. Somente administradores podem fazer alterações nela.
				</C.BrandText>
				<C.BrandFooter>
					<Close asChild>
